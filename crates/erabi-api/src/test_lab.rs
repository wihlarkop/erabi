...
pub(crate) fn test_lab_openapi_schemas() -> BTreeMap<&'static str, Value> {
    ...
    schemas.insert("DiscoveredUrlEvidence", serde_json::json!({"type":"object","required":["raw_href","resolved_original_url","canonical_url","canonicalization","scope","duplicate","duplicate_of_canonical_url","page_type_match","transition_eligible","budget"],"properties":{"raw_href":{"type":"string"},"resolved_original_url":{"type":["string","null"],"format":"uri"},"canonical_url":{"type":["string","null"],"format":"uri"},"canonicalization":{"$ref":"#/components/schemas/CanonicalizationEvidence"},"scope":{"$ref":"#/components/schemas/DomainScopeEvidence"},"duplicate":{"type":"boolean"},"duplicate_of_canonical_url":{"type":["string","null"],"format":"uri"},"page_type_match":{"$ref":"#/components/schemas/PageTypeMatchEvidence"},"transition_eligible":{"type":"boolean"},"budget":{"$ref":"#/components/schemas/TransitionBudgetEvidence"}}}));
    ...
    schemas.insert("DiscoveryTransitionEvidence", serde_json::json!({"type":"object","required":["transition_id","transition_name","source_page_type_id","target_page_type_id","selector","discovered_urls","eligible_link_count","per_page_limit","per_page_limit_reached"],"properties":{"transition_id":{"type":["string","null"],"format":"uuid"},"transition_name":{"type":["string","null"]},"source_page_type_id":{"type":["string","null"],"format":"uuid"},"target_page_type_id":{"type":["string","null"],"format":"uuid"},"source_match":{"$ref":"#/components/schemas/PageTypeMatchEvidence"},"selector":{"$ref":"#/components/schemas/SelectorCoverageEvidence"},"discovered_urls":{"type":"array","maxItems":64},"eligible_link_count":{"type":"integer","minimum":0},"per_page_limit":{"type":"integer","minimum":0},"per_page_limit_reached":{"type":"boolean"}}}));
