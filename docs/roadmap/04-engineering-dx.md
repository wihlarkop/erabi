...
| **DX-D03** | **CURRENT** | **Establish the canonical pre-release checkpoint/recovery contract, naming, ownership, persistence format, and failure semantics before Plan 07.** |
