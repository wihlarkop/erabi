...
| DX-D02b | CURRENT | Add semantic runtime observability across jobs, crawler, API, CLI, provider execution, diagnostics, and terminal repair without changing business truth. |
